...
<div class="content">
    ...
    <div class="main-content">
        <form action="welcome.jsp" method="post">
            ...
            <input required id="email" name="email" type="text" placeholder="example@example.com"/>

            <label for="password">PASSWORD</label>
            <input required id="password" name="password" type="password" placeholder="Use a strong password"/>

            <label for="genre">FAVOURITE GENRE</label>
            <select requred name="genre" id="genre">
